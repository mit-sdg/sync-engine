...
| [`docs/project/concept-specification-processing.md`](concept-specification-processing.md) | Explanation  | Concept, vocabulary, prose processing, enforcement, and deferred questions |
