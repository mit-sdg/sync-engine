...
| [`docs/project/concept-specification-processing.md`](concept-specification-processing.md) | Explanation  | Concept, SSF, instance/binding, prose processing, and enforcement boundaries |
