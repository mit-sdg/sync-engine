...
shapes with resolvable TypeScript source. It also uses exact SSF structural, safely evidenced, and explicit-alias names to prove
...
bindings, exact SSF-derived definition-owned type inventories, resolved application types,
