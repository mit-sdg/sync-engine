...
assert(manifest.generator.version === "1.0.0-beta.11", "packed core provenance is not beta.11");
...
`,
  ...
  assert(
    project.provenance.analyzer.version === "1.0.0-beta.11",
    "packed analyzer provenance is not beta.11",
  );
  ...
  assert(
    project.provenance.manifest.generator.version === "1.0.0-beta.11",
    "packed project core provenance is not beta.11",
  );
  assert(
