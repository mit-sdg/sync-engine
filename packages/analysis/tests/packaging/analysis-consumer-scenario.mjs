...
assert(manifest.generator.version === "1.0.0-beta.15", "packed core provenance is not beta.15");
...
`,
  ...
  assert(
    project.provenance.analyzer.version === "1.0.0-beta.15",
    "packed analyzer provenance is not beta.15",
  );
  ...
  assert(
    project.provenance.manifest.generator.version === "1.0.0-beta.15",
    "packed project core provenance is not beta.15",
  );
  assert(
