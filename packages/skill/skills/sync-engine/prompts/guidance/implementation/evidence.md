...
lifecycle, integration, host behavior, partial failure, and recovery. Do not duplicate a
large implementation test suite or bless alternate routes, credentials, fields, CORS, or
