...
A reaction cannot make separate owners atomic. Realize every accepted-map obligation
with its triggering action, closing reaction, observable false interval, stable retry
