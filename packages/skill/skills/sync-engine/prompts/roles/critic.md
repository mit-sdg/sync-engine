...
Review the complete syntax-passing candidate against the brief. Be read-only and use
only supplied prompt material. Do not inspect source, generated files, Git, package
