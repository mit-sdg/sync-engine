...
describe("representative prompt bytes", () => {
  test("matches the task-manager designer golden prompt", async () => {
    ...
    expect(built.sha256).toBe("349ae6202e616f1faaaba639305592b0dbd1c537dcff53d2ab87698449a8742d");
  });
  ...
  test("matches the message-board critic golden prompt", async () => {
    ...
    expect(built.sha256).toBe("8eae8cc8d63e239f03c72f677d9c4d9f2ac3cdfd362a29d40e0e9f11734eae37");
  });
});
