...
describe("representative prompt bytes", () => {
  test("matches the task-manager designer golden prompt", async () => {
    ...
    expect(built.sha256).toBe("93245df68c060dfcded990913095c7649c6e668c3036c0f992702da4e2a14ccc");
  });
  ...
  test("matches the message-board critic golden prompt", async () => {
    ...
    expect(built.sha256).toBe("1a6b54c49d84ae6b40d341567a2aa92bfaabdf4cd4cab693b2be0af9393b7a9a");
  });
});
