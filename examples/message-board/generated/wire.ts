// Generated by @mit-sdg/sync-engine@1.0.0-beta.8 from the Message board assembly. Do not edit.
// Projectors: @mit-sdg/sync-engine-http@1.0.0-beta.8.

import type { vocabulary as ApplicationVocabulary } from "../src/vocabulary.ts";
...
export type MessageBoardWire = {
  "/auth/current": {
    ...
    output: {
      "username": Jsonify<AtPath<Awaited<ReturnType<(typeof ApplicationVocabulary.concepts)["Sessioning"]["current"]>>, ["subject"]>>;
    };
  ...
  "/auth/sign-in": {
    input: {
      ...
      "username": Jsonify<OneOf<[AtPath<Parameters<(typeof ApplicationVocabulary.concepts)["Authenticating"]["authenticate"]>[0], ["username"]>, AtPath<Parameters<(typeof ApplicationVocabulary.concepts)["Sessioning"]["start"]>[0], ["subject"]>]>>;
    };
    output: {
      "expiresAt": Jsonify<AtPath<Awaited<ReturnType<(typeof ApplicationVocabulary.concepts)["Sessioning"]["start"]>>, ["expiresAt"]>>;
      "session": Jsonify<AtPath<Awaited<ReturnType<(typeof ApplicationVocabulary.concepts)["Sessioning"]["start"]>>, ["session"]>>;
  ...
  "/auth/sign-out": {
    ...
    output: {
      "signedOut": Jsonify<AtPath<Awaited<ReturnType<(typeof ApplicationVocabulary.concepts)["Sessioning"]["end"]>>, ["ended"]>>;
    };
    error: { error: AppWideError | "INVALID_INPUT" | "UNKNOWN_SESSION" };
  };
  "/board/comment": {
    input: {
      "content": Jsonify<AtPath<Parameters<(typeof ApplicationVocabulary.concepts)["Commenting"]["add"]>[0], ["content"]>>;
      "session": Jsonify<AtPath<Parameters<(typeof ApplicationVocabulary.concepts)["Sessioning"]["current"]>[0], ["session"]>>;
      "target": Jsonify<OneOf<[AtPath<Parameters<(typeof ApplicationVocabulary.concepts)["Commenting"]["add"]>[0], ["target"]>, AtPath<Parameters<(typeof ApplicationVocabulary.concepts)["Posting"]["_get"]>[0], ["post"]>]>>;
    };
    output: {
      "comment": Jsonify<AtPath<Awaited<ReturnType<(typeof ApplicationVocabulary.concepts)["Commenting"]["add"]>>, ["comment"]>>;
    };
  ...
  "/board/list": {
    ...
    output: {
      "board": {
        "posts": {
          "author": Jsonify<AtPath<QueryRow<Awaited<ReturnType<(typeof ApplicationVocabulary.concepts)["Posting"]["_all"]>>>, ["author"]>>;
          "comments": {
            "author": Jsonify<AtPath<QueryRow<Awaited<ReturnType<(typeof ApplicationVocabulary.concepts)["Commenting"]["_for"]>>>, ["author"]>>;
            "comment": Jsonify<AtPath<QueryRow<Awaited<ReturnType<(typeof ApplicationVocabulary.concepts)["Commenting"]["_for"]>>>, ["comment"]>>;
            "content": Jsonify<AtPath<QueryRow<Awaited<ReturnType<(typeof ApplicationVocabulary.concepts)["Commenting"]["_for"]>>>, ["content"]>>;
          }[];
          "content": Jsonify<AtPath<QueryRow<Awaited<ReturnType<(typeof ApplicationVocabulary.concepts)["Posting"]["_all"]>>>, ["content"]>>;
          "post": Jsonify<AtPath<QueryRow<Awaited<ReturnType<(typeof ApplicationVocabulary.concepts)["Posting"]["_all"]>>>, ["post"]>>;
        }[];
      };
    };
    error: { error: AppWideError | "INVALID_INPUT" | "UNKNOWN_SESSION" };
  ...
  "/board/post": {
    input: {
      "content": Jsonify<AtPath<Parameters<(typeof ApplicationVocabulary.concepts)["Posting"]["publish"]>[0], ["content"]>>;
      "session": Jsonify<AtPath<Parameters<(typeof ApplicationVocabulary.concepts)["Sessioning"]["current"]>[0], ["session"]>>;
    };
    output: {
