...
for that account's username. [Sign-in](reaction:Sessions.EnteringApplication.SignIn)
proves an existing account's credentials and starts a new session for the same
username. In both cases callers cannot choose a different subject.
