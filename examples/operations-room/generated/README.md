# Generated operations-room artifacts
...
- [`operations-room.md`](operations-room.md) is the assembled read-back. It
  projects each registered concept's Purpose and Principle and renders the
  reactions, views, formers, and boundary declarations selected by the
  assembly. It is derived evidence, not the full authored design.
...
composition under [`../src/composition/`](../src/composition/), and change
assembly choices in [`../src/assembly.ts`](../src/assembly.ts). Then regenerate
the evidence here; do not edit either output by hand.
