...
```endpoints
Room.RoomMembership.CreateRoom at /rooms/create
Room.RoomMembership.JoinRoom at /rooms/join
```
...
```endpoints
Room.MitigationSelection.ChooseMitigation at /rooms/choose-mitigation
```
...
```endpoints
Room.RoomDashboard.GetRoom at /rooms/get
```
