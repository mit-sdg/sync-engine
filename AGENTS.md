...
- Rendering declarations and invocation contract: `packages/rendering/public-surface.md`
...
| `packages/rendering/`            | Portable renderer declarations, invocations, and package-owned contract tests                                                       |
