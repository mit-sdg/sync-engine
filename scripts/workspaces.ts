...
export const workspaceCatalog = [
  {
    ...
    packageBudget: { files: 422, packedBytes: 500_000, unpackedBytes: 1_650_000 },
  ...
  },
  {
    ...
    forbiddenWorkspaceIds: ["http", "catalog", "skill", "rendering", "web", "server", "context"],
  ...
  },
  {
    ...
    peerWorkspaceIds: [],
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["analysis", "http", "skill", "rendering", "web", "server", "context"],
    internalSourceDirectories: [],
  ...
  },
  {
    ...
    buildAfter: ["analysis", "catalog"],
    peerWorkspaceIds: [],
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["core", "http", "rendering", "web", "server", "context"],
    internalSourceDirectories: [],
    runtimeEntrypoints: [],
    publicSubpathContainsOnlyEntrypoint: false,
    copiesExamples: false,
    ...
    packageBudget: { files: 10, packedBytes: 20_000, unpackedBytes: 60_000 },
    assets: [],
    bins: [],
  },
  {
    id: "rendering",
    packageName: "@mit-sdg/sync-engine-rendering",
    directory: "packages/rendering",
    packageManifest: "packages/rendering/package.json",
    sourceDirectory: "src",
    distDirectory: "dist",
    buildConfig: "tsconfig.build.json",
    declarationSnapshot: "packages/rendering/tests/declarations.snapshot.txt",
    verifiedTarball: "rendering-package.tgz",
    buildAfter: ["core"],
    peerWorkspaceIds: ["core"],
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["analysis", "http", "catalog", "skill", "web", "server", "context"],
    internalSourceDirectories: [],
    runtimeEntrypoints: [],
    publicSubpathContainsOnlyEntrypoint: false,
    copiesExamples: false,
    publication: "private",
    requiredPackedFiles: ["README.md", "public-surface.md", "package.json"],
    packageBudget: { files: 18, packedBytes: 40_000, unpackedBytes: 120_000 },
    assets: [],
    bins: [],
  },
  {
    id: "context",
    packageName: "@mit-sdg/sync-engine-context",
    directory: "packages/context",
    packageManifest: "packages/context/package.json",
    sourceDirectory: "src",
    distDirectory: "dist",
    buildConfig: "tsconfig.build.json",
    declarationSnapshot: "packages/context/tests/declarations.snapshot.txt",
    verifiedTarball: "context-package.tgz",
    buildAfter: ["core", "rendering"],
    peerWorkspaceIds: ["core", "rendering"],
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["analysis", "http", "catalog", "skill", "web", "server"],
    internalSourceDirectories: [],
    runtimeEntrypoints: [],
    publicSubpathContainsOnlyEntrypoint: false,
    copiesExamples: false,
  ...
  {
    id: "web",
    packageName: "@mit-sdg/sync-engine-web",
    directory: "packages/web",
    packageManifest: "packages/web/package.json",
    sourceDirectory: "src",
    distDirectory: "dist",
    buildConfig: "tsconfig.build.json",
    declarationSnapshot: "packages/web/tests/declarations.snapshot.txt",
    verifiedTarball: "web-package.tgz",
    buildAfter: ["core", "http", "rendering"],
    peerWorkspaceIds: ["core", "http", "rendering"],
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["analysis", "catalog", "skill", "server", "context"],
    internalSourceDirectories: [],
    runtimeEntrypoints: [],
    publicSubpathContainsOnlyEntrypoint: false,
    copiesExamples: false,
    publication: "private",
    requiredPackedFiles: ["README.md", "public-surface.md", "package.json"],
    packageBudget: { files: 14, packedBytes: 40_000, unpackedBytes: 120_000 },
    assets: [],
    bins: [],
  },
  {
    id: "server",
    packageName: "@mit-sdg/sync-engine-server",
    directory: "packages/server",
    packageManifest: "packages/server/package.json",
    sourceDirectory: "src",
    distDirectory: "dist",
    buildConfig: "tsconfig.build.json",
    declarationSnapshot: "packages/server/tests/declarations.snapshot.txt",
    verifiedTarball: "server-package.tgz",
    buildAfter: ["core", "http"],
    peerWorkspaceIds: ["core", "http"],
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["analysis", "catalog", "skill", "rendering", "web", "context"],
    internalSourceDirectories: [],
    runtimeEntrypoints: [],
    publicSubpathContainsOnlyEntrypoint: false,
    copiesExamples: false,
    publication: "private",
    requiredPackedFiles: ["README.md", "public-surface.md", "package.json"],
    packageBudget: { files: 14, packedBytes: 30_000, unpackedBytes: 90_000 },
    assets: [],
    bins: [],
  },
