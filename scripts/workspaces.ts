...
export const workspaceCatalog = [
  {
    ...
    forbiddenWorkspaceIds: ["http", "analysis", "catalog", "skill", "rendering"],
    ...
    packageBudget: { files: 420, packedBytes: 500_000, unpackedBytes: 1_650_000 },
  ...
  },
  {
    ...
    forbiddenWorkspaceIds: ["http", "catalog", "skill", "rendering"],
  ...
  },
  {
    ...
    peerWorkspaceIds: ["core"],
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["analysis", "catalog", "skill", "rendering"],
    internalSourceDirectories: [],
    runtimeEntrypoints: [],
    publicSubpathContainsOnlyEntrypoint: false,
    copiesExamples: false,
  ...
  },
  {
    ...
    peerWorkspaceIds: [],
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["analysis", "http", "skill", "rendering"],
    internalSourceDirectories: [],
  ...
  },
  {
    ...
    peerWorkspaceIds: [],
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["core", "http", "rendering"],
    internalSourceDirectories: [],
    runtimeEntrypoints: [],
    publicSubpathContainsOnlyEntrypoint: false,
    copiesExamples: false,
  ...
  },
  {
    ...
    peerWorkspaceIds: ["core"],
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["analysis", "http", "catalog", "skill"],
    internalSourceDirectories: [],
    runtimeEntrypoints: [],
    publicSubpathContainsOnlyEntrypoint: false,
    copiesExamples: false,
