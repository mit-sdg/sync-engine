...
export const workspaceCatalog = [
  ...
  },
  {
    ...
    peerWorkspaceIds: [],
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["http", "ssf", "rendering", "web", "server", "context"],
    internalSourceDirectories: [],
    runtimeEntrypoints: ["command.ts"],
    publicSubpathContainsOnlyEntrypoint: false,
    copiesExamples: false,
    ...
    requiredPackedFiles: [
      ...
      "skills/sync-engine/prompts/common/internals.md",
      ...
      "skills/sync-engine/prompts/inputs/boundary.md",
