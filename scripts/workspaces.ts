...
export const workspaceCatalog = [
  {
    ...
    forbiddenWorkspaceIds: ["http", "analysis", "catalog", "skill", "rendering", "web", "server"],
  ...
  },
  {
    ...
    forbiddenWorkspaceIds: ["http", "catalog", "skill", "rendering", "web", "server"],
  ...
  },
  {
    ...
    peerWorkspaceIds: ["core"],
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["analysis", "catalog", "skill", "rendering", "web", "server"],
    internalSourceDirectories: [],
    runtimeEntrypoints: [],
    publicSubpathContainsOnlyEntrypoint: false,
    copiesExamples: false,
  ...
  },
  {
    ...
    peerWorkspaceIds: [],
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["analysis", "http", "skill", "rendering", "web", "server"],
    internalSourceDirectories: [],
  ...
  },
  {
    ...
    peerWorkspaceIds: [],
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["core", "http", "rendering", "web", "server"],
    internalSourceDirectories: [],
    runtimeEntrypoints: [],
    publicSubpathContainsOnlyEntrypoint: false,
    copiesExamples: false,
  ...
  },
  {
    ...
    packageBudget: { files: 12, packedBytes: 20_000, unpackedBytes: 60_000 },
    assets: [],
    bins: [],
  },
  {
    ...
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["analysis", "catalog", "skill", "server"],
    internalSourceDirectories: [],
    runtimeEntrypoints: [],
    publicSubpathContainsOnlyEntrypoint: false,
    copiesExamples: false,
  ...
  },
  {
    ...
    rootRuntimeDependencies: [],
    forbiddenWorkspaceIds: ["analysis", "catalog", "skill", "rendering", "web"],
    internalSourceDirectories: [],
    runtimeEntrypoints: [],
    publicSubpathContainsOnlyEntrypoint: false,
    copiesExamples: false,
