...
export const workspaceCatalog = [
  ...
  },
  {
    ...
    requiredPackedFiles: [
      ...
      "skills/sync-engine/scripts/native-launch.ts",
      "skills/sync-engine/scripts/prompt.ts",
      "skills/sync-engine/scripts/review.ts",
      ...
      "skills/sync-engine/references/harnesses/codex.md",
      "skills/sync-engine/references/harnesses/claude-code.md",
      "skills/sync-engine/references/harnesses/antigravity.md",
      "skills/sync-engine/prompts/SOURCES.md",
      "skills/sync-engine/prompts/common/design.md",
      "skills/sync-engine/prompts/common/design-map.md",
      "skills/sync-engine/prompts/common/design-contract.md",
      "skills/sync-engine/prompts/common/worker-boundary.md",
      "skills/sync-engine/prompts/common/ssf.md",
      "skills/sync-engine/prompts/common/concept-format.md",
      "skills/sync-engine/prompts/common/ssf-reading.md",
      "skills/sync-engine/prompts/common/internals.md",
      "skills/sync-engine/prompts/roles/designer.md",
      "skills/sync-engine/prompts/roles/designer-contract.md",
      "skills/sync-engine/prompts/roles/critic.md",
      "skills/sync-engine/prompts/roles/critic-map.md",
      ...
      "skills/sync-engine/prompts/inputs/catalog.md",
      "skills/sync-engine/prompts/inputs/composition.md",
      "skills/sync-engine/prompts/inputs/http-host.md",
      "skills/sync-engine/prompts/inputs/http-client.md",
      "skills/sync-engine/prompts/templates/product-brief.md",
    ],
    packageBudget: { files: 57, packedBytes: 100_000, unpackedBytes: 375_000 },
    assets: [],
    bins: ["dist/command.js"],
  },
  {
