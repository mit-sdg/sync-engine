  ...
  return {
    ...
    wireBanner:
      application.wireBanner === undefined
        ? `// Generated by ${generator} from the ${application.title} assembly. Do not edit.`
...
export function renderGenerated(application: ResolvedApplication) {
  ...
  return {
    metrics: {
      ...
      localBehavior: design.localBehavior,
      compute: JSON.stringify(design.app).match(/"op":"compute"/g)?.length ?? 0,
    },
    specification:
      `<!-- Generated by ${PACKAGE_NAME}@${PACKAGE_VERSION} from the ${application.title} assembly. Do not edit. -->\n\n` +
      renderApp({ title: application.title, concepts: design.concepts, app: design.app }) +
      (design.localBehavior.observed.length === 0
        ? ""
        : `\n${renderLocalBehaviorMarkdown(design.localBehavior)}`) +
      "\n" +
